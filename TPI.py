                ...
                while control == True: #si control es true, el codigo se seguirá ejecutando, si es false saldrá del ciclo.
                        if (mis_puntos < puntos and puntos_rival < puntos):  
                            if juego ==1: #si el usuario elegió la opcion 1 significa que jugará contra otro jugador real
                                ...
                                jugador1 = getpass.getpass("\nJugador 1🕹️:  1=Piedra, 2=Papel, 3=Tijera: ") #el getpass.getpass sirve para que no se vea lo que esta ingresando el usuario 
                                ...
                                jugador2 = getpass.getpass("\nJugador 2🕹️:  1=Piedra, 2=Papel, 3=Tijera: ")
                                ...
                                print("Error. Opcion Incorrecta.") #si el usuario en el menú del juego selecciona una opción distinta a 1, 2 o 3 se le mostrará este mensaje.    
                        ...
                        elif puntos_rival == puntos: #si el jugador 2 llega a los puntos necesarios para ganar, la partida finalizará y se mostrara lo mismo que en el caso del jugador 1.
                                time.sleep(4)
                                print("      ⚔️ 𝐹𝒾𝓃 𝒹𝑒 𝓁𝒶 𝓅𝒶𝓇𝓉𝒾𝒹𝒶⚔️\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n \n      Ganador: Jugador 2. 🏆\n \n         🪨     📜    ✂️\n \n      Gracias por jugar. 🫶\n \n┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n")
                                time.sleep(6)
                                print("Volviendo al menu del juego...\n")
                                time.sleep(3) 
                                control = False           
            elif puntos <=0 or puntos >10: #si a la hora de elegir los puntos a jugar se comete algun error y no se respetan las reglas, se mostrará el siguiente mensaje. 
                #if juego == 1 or juego ==2: #este condicional está debido a que si el jugador seleccionó la opción 3 y quiere volver al menú, nunca entra a elegir la cantidad de puntos a jugar y la variable "puntos" al estar inicializada en 0 el codigo entra a mostrar el error.
                #se agregó un break arriba que nos ahorró el uso de un condicional extra.
                print(" \n「 ✦ 𝒫𝒾𝑒𝒹𝓇𝒶, 𝒫𝒶𝓅𝑒𝓁 𝑜 𝒯𝒾𝒿𝑒𝓇𝒶 ✦ 」\n┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n              ⚠️        \n  Los puntos a jugar deben ser\n  minimo de 1 y maximo de 10\n  para una mejor experiencia. \n\n  Porfavor vuelva a intentarlo.\n\n┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛")
                time.sleep(6) #tiempo para que el jugador lea el mensaje antes de volver al menú del juego.